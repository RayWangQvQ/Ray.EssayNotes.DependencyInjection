...
namespace System
{
    public static class MsDiExtension
    {
        ...
        public static IEnumerable<ServiceDescriptorDto> MapToServiceDescriptorDto(this IEnumerable<ServiceDescriptor> serviceDescriptors)
        {
            return serviceDescriptors.Select(x => new ServiceDescriptorDto(x));
        }
